    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <video
          ...
          playsInline
        />
        <div className="absolute inset-0" style={{ background: 'linear-gradient(to bottom, rgba(6,13,8,0.5), rgba(15,61,36,0.6), rgba(6,13,8,0.7))' }} />
      </div>
      ...
      <div className="relative z-20 flex flex-col items-center text-center px-8">
        ...
        {/* Tag line */}
        <motion.div
          className="flex flex-wrap justify-center gap-x-4 gap-y-1 mb-8"
        ...
        >
          {['Every shed.', 'Every batch.', 'Every day.'].map((word, i) => (
            <motion.span
              ...
              style={{ fontSize: 'clamp(16px, 3.5vw, 40px)', textShadow: '0 2px 16px rgba(0,0,0,0.6)' }}
        ...
        >
          <img
            src={`${BASE}logo.png`}
            alt="Farm Buddy"
            style={{ height: 'clamp(60px, 10vw, 120px)', width: 'auto', filter: 'drop-shadow(0 8px 30px rgba(0,0,0,0.7))' }}
          />
          <motion.div
            className="mt-3 font-black text-white uppercase tracking-widest"
            style={{ fontSize: 'clamp(18px, 3.5vw, 40px)', textShadow: '0 4px 20px rgba(0,0,0,0.8)' }}
            initial={{ opacity: 0 }}
          ...
          <div
            className="font-semibold text-white/50 uppercase tracking-widest mt-1"
        ...
        >
          ...
          <motion.div
            ...
            style={{ fontSize: 'clamp(11px, 1.8vw, 20px)', color: 'var(--color-accent)', textShadow: '0 2px 12px rgba(0,0,0,0.5)' }}
            initial={{ opacity: 0 }}
