...
function AddToHomeScreenSection() {
  ...
  const handleInstall = async () => {
    ...
    if (outcome === "accepted") {
      setInstalled(true);
      toast({ title: "App installed!", description: "Find Farm Buddy on your home screen." });
    }
        ...
        {isInstalled || installed ? (
          <div className="flex items-center gap-3 px-4 py-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Farm Buddy is on your home screen</p>
            </div>
          </div>
        ) : isIos ? (
    ...
    <div className="px-3 py-3 pb-8 space-y-5">
      ...
      <div>
        ...
        <div className="bg-card border border-border/50 rounded-2xl px-4 py-4 space-y-1">
          <p className="font-bold text-foreground">Farm Buddy</p>
